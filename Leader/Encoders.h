...
volatile byte state_RIGHT; // used to determine quadrature state
...
ISR( PCINT0_vect ) {
  ...
  //boolean LEFT_B = PINE & B00000100;  // Does same as above.
...
void setupEncoder0()
{
  ...
  // initialise the recorded state of RIGHT encoder.
  state_RIGHT = 0;
...
void setupEncoder1(){
  ...
  // initialise the recorded state of LEFT encoder.
  state_LEFT = 0;
